...
import com.sugengwin.multimatics.myshoppingmall.api.request.PostRegisterRequest;
import com.sugengwin.multimatics.myshoppingmall.api.response.BaseResponse;
        ...
        if (v.getId() == R.id.btn_register) {
            ...
            if (TextUtils.isEmpty(username) || TextUtils.isEmpty(password) || TextUtils.isEmpty(email)) {
                ...
                if (cbToc.isChecked()) {
                    ...
                    Toast.makeText(RegisterActivity.this, "You must agree with our term and condition", Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
